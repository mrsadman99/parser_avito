URL_INPUT_HELP = ("Вы можете вставить до 100 ссылок. Все настройки будут общие для каждой ссылки\n"
                  "Ссылки будут обработаны в указанном порядке.\nВсе параметры вшитые в ссылку будут работать.\n"
                  "Если нужны только новые объявления - в ссылке должно быть 's=104'\n"
                  "Цену на отдельную ссылку задавайте в config.toml в секции links:\n"
                  "  \"ссылка\" = { min_price = 10000, max_price = 50000 }")
...
MIN_DELAY_HELP = "Минимальная случайная задержка между запросами к Avito (сек). Запросы к Avito из всех ссылок идут в общей очереди."
MAX_DELAY_HELP = "Максимальная случайная задержка между запросами к Avito (сек). Запросы к Avito из всех ссылок идут в общей очереди."
